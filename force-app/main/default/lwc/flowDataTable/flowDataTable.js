...
import getReturnResults from '@salesforce/apex/FlowDataTableController.getReturnResults';
...
export default class flowDataTable extends LightningElement {
    ...
    get noRowsSelected() {
        return this.outputSelectedRows?.length === 0;
    }
    ...
    updateDataRows() {
        ...
        data.forEach(record => {
            ...
            lookupFields.forEach(lookup => {
                if (this.isUserDefinedObject) {
                    ...
                    if (record[lufield]) {               
                        ...
                        record[lufield + '_lookup'] = MYDOMAIN + '/customercareplus/s/' + lookupFieldObject['object'] + '/' + record[lufield + '_id'];
                    }
                }
            }); 
            ...
            record[this.objectLinkField + '_lookup'] = MYDOMAIN + '/customercareplus/s/' + this.objectName + '/' + record['Id'];
