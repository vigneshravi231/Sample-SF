...
import fetchRecordTypeId from "@salesforce/apex/FormController.getRecordTypeId";
import { auraExceptionHandler } from "c/auraExceptionHandler";

export default class hondaChangeOfOwnershipForm extends NavigationMixin(LightningElement){
    ...
    connectedCallback() {
        fetchRecordTypeId({ recordTypeName: 'Honda C of O' })
          .then(result => {
    ...
    submitWarranty() {
        this.fields.Subject = 'Honda Odyssey Change of Ownership';
